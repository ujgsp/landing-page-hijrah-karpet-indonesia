				...
				<div class="col-md-7 product-view">
					...
					<div class="flexslider">
						<ul class="slides" id="slides_1">
							<li data-thumb="img/produk/abi_custom/abi_custom_ht550/2.jpeg">
								<img src="img/produk/abi_custom/abi_custom_ht550/2.jpeg" style="width: 50%; border-radius: 10px;" />
							</2a>
						<li data-thumb="img/produk/abi_custom/abi_custom_ht550/2a.jpeg">
								<img src="img/produk/abi_custom/abi_custom_ht550/2a.jpeg" style="width: 70%; border-radius: 10px;" />
							</li>
							<li data-thumb="img/produk/abi_custom/abi_custom_ht550/2b.jpeg">
								<img src="img/produk/abi_custom/abi_custom_ht550/2b.jpeg" style="width: 70%; border-radius: 10px;" />
							</li>
