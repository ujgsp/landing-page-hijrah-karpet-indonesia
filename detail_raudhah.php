	...
	<div class="single-page main-grid-border">
		<div class="container">
			<ol class="breadcrumb" style="margin-bottom: 5px;">
				...
				<li><a href="categories.html#parentVerticalTab2">Kategori</a></li>
				<!-- <li class="active"><a href="mobiles.html">Mobiles</a></li> -->
				<li class="active">Karpet Roll Raudhah</li>
			</ol>
			<div class="product-desc">
				<div class="col-md-7 product-view">
					<h2>Karpet Roll Raudhah - Warna Hijau list hijau muda</h2>
					...
					<div class="flexslider">
						<ul class="slides" id="slides_1">
							<li data-thumb="img/produk/raudah/hijau_1.jpeg">
								<img src="img/produk/raudah/hijau_1.jpeg" style="width: 70%; border-radius: 10px;" />
							</li>
							<li data-thumb="img/produk/raudah/hijau_2.jpeg">
								<img src="img/produk/raudah/hijau_2.jpeg" style="width: 70%; border-radius: 10px;" />
							</li>
					...
					<div class="product-details">
						<h4>Nama Produk : <a href="#">Karpet Roll Raudhah</a></h4>
						<h4>Harga: <strong>Rp. 283.500 / m</strong></h4>
						<p><strong>Ukuran </strong>: Lebar 120 cm, panjang 30 m</p>
						<p><strong>Bahan </strong>: Polypropylene, Lembut dan Halus</p>
						<p><strong>Ketebalan </strong>: 9 mm</p>
						<p><strong>Warna </strong>: Hijau dengan list warna hijau muda</p>
				...
				<div class="col-md-5 product-details-grid">
					<div class="item-price" style="border-radius: 20px;">
						<div class="product-price">
							...
							<h3 class="rate" style="font-size: 20px">Rp. 283.500 / m</h3>
							<!-- <h4>Rp. 141.750 / m</h4> -->
