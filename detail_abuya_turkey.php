		...
		<div class="container">
			...
			<div class="product-desc">
				<div class="col-md-7 product-view">
					<h2>Karpet Roll Abuya Turkey - Warna Hijau </h2>
					...
					<div class="flexslider">
						<ul class="slides" id="slides_1">
							<li data-thumb="img/produk/abuya_turkey/3.jpeg">
								<img src="img/produk/abuya_turkey/3.jpeg" style="width: 50%; border-radius: 10px;" />
							</li>
2						<li data-thumb="img/produk/abuya_turkey/4.jpeg">
								<img src="img/produk/abuya_turkey/4.jpeg" style="width: 50%; border-radius: 10px;" />
							</li>
