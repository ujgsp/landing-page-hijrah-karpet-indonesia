		...
		<div class="container">
			...
			<div class="product-desc">
				<div class="col-md-7 product-view">
					<h2>Karpet Roll Muhsinin - Warna Merah list cream </h2>
					...
					<div class="flexslider">
						<ul class="slides" id="slides_1">
							<li data-thumb="img/produk/muhsinin/3.jpeg">
								<img src="img/produk/muhsinin/3.jpeg" style="width: 70%; border-radius: 10px;" />
							</li>
							<li data-thumb="img/produk/muhsinin/4.jpeg">
								<img src="img/produk/muhsinin/4.jpeg" style="width: 70%; border-radius: 10px;" />
							</li>
