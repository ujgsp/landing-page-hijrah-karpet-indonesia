	...
	<div class="single-page main-grid-border">
		<div class="container">
			<ol class="breadcrumb" style="margin-bottom: 5px;">
				...
				<li><a href="categories.html#parentVerticalTab3">Kategori</a></li>
				<!-- <li class="active"><a href="mobiles.html">Mobiles</a></li> -->
				<li class="active">Karpet Roll Buya</li>
			</ol>
			<div class="product-desc">
				<div class="col-md-7 product-view">
					<h2>Karpet Roll Buya - Warna Hijau</h2>
					...
					<div class="flexslider">
						<ul class="slides" id="slides_1">
							<li data-thumb="img/produk/buya/1.jpeg">
								<img src="img/produk/buya/1.jpeg" style="width: 70%; border-radius: 10px;" />
							</li>
							<!-- <li data-thumb="img/produk/buya/2.jpeg">
								<img src="img/produk/buya/2.jpeg" style="width: 70%; border-radius: 10px;" />
							</li> -->
					...
					<div class="product-details">
						<h4>Nama Produk : <a href="#">Karpet Roll Buya</a></h4>
						<h4>Harga: <strong>Rp. 414.750 / m</strong></h4>
						<p><strong>Ukuran </strong>: Lebar 120 cm, panjang 30 m</p>
						<p><strong>Bahan </strong>: Polypropylene, bahan lembut dan tipis</p>
						<p><strong>Ketebalan </strong>: 11 mm</p>
				...
				<div class="col-md-5 product-details-grid">
					<div class="item-price" style="border-radius: 20px;">
						<div class="product-price">
							...
							<h3 class="rate" style="font-size: 20px">Rp. 414.750 / m</h3>
							<!-- <h4>Rp. 141.750 / m</h4> -->
