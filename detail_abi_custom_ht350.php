	...
	<div class="single-page main-grid-border">
		<div class="container">
			<ol class="breadcrumb" style="margin-bottom: 5px;">
				...
				<li class="active">Karpet Roll Abi</li>
			</ol>
				...
				<div class="col-md-7 product-view">
					...
					<div class="flexslider">
						<ul class="slides" id="slides_1">
							<li data-thumb="img/produk/abi_custom/1.jpeg">
								<img src="img/produk/abi_custom/1.jpeg" style="width: 70%; border-radius: 10px;" />
							</li>
						<li data-thumb="img/produk/abi_custom/1a.jpeg">
								<img src="img/produk/abi_custom/1a.jpeg" style="width: 70%; border-radius: 10px;" />
							</li>
