		...
		<div class="container">
			...
			<div class="product-desc">
				<div class="col-md-7 product-view">
					<h2>Karpet Roll Raudhah - Warna Merah list cream</h2>
					...
					<div class="flexslider">
						<ul class="slides" id="slides_1">
							<li data-thumb="img/produk/raudah/merah_1.jpeg">
								<img src="img/produk/raudah/merah_1.jpeg" style="width: 70%; border-radius: 10px;" />
							</li>
							<li data-thumb="img/produk/raudah/merah_2.jpeg">
								<img src="img/produk/raudah/merah_2.jpeg" style="width: 70%; border-radius: 10px;" />
							</li>
					...
					<div class="product-details">
						...
						<p><strong>Warna </strong>: Warna Merah list cream</p>
